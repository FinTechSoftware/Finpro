...
import style from './fp-drawer.css';
...
export default class FpDrawer extends FinproElement {
   ...
   */
  @event('fp-drawer-open') private onOpen: EventDispatcher<string>;

  /**
   * Fires when the drawer is closed
   */
  @event('fp-drawer-close') private onClose: EventDispatcher<string>;

  connectedCallback() {
    super.connectedCallback();
    window?.addEventListener('fp-drawer-open', event => {
