...
import style from './fp-tooltip.css';
...
export default class FpTooltip extends LitElement {
   ...
   */
  @event('fp-tooltip-show') private onShow: EventDispatcher<string>;

  /**
   * Fires when leaving over from trigger
   */
  @event('fp-tooltip-hide') private onHide: EventDispatcher<string>;
