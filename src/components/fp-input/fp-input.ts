...
import style from './fp-input.css';
 ...
 */
@customElement('fp-input')
export default class FpInput extends FormControlMixin(LitElement) {
   ...
   */
  @event('fp-change') private onChange: EventDispatcher<string>;

  /**
   * Fires when the value of an input element has been changed.
   */
  @event('fp-input') private onInput: EventDispatcher<string>;

  /**
   * Fires when the value of an input element has been changed.
   */
  @event('fp-invalid') private onInvalid: EventDispatcher<ValidityState>;
  ...
  render(): TemplateResult {
    ...
    const icon = this.icon ? html`<fp-icon class="custom-icon" name="${this.icon}"></fp-icon>` : '';
